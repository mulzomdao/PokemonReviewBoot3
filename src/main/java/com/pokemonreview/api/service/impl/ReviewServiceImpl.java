...
public class ReviewServiceImpl implements ReviewService {
    ...
    private Pokemon getExistPokemon(int pokemonId) {
        Pokemon pokemon = pokemonRepository
                .findById(pokemonId)
                .orElseThrow(() -> new ResourceNotFoundException("Pokemon with associated review not found"));
        return pokemon;
    }
    ...
    private Review getExistReview(int reviewId) {
        Review review = reviewRepository
                .findById(reviewId)
                .orElseThrow(() -> new ResourceNotFoundException("Review with associate pokemon not found"));
        return review;
    }
